...
-- managing line number between insert and other modes
-- set to absoloute number, gets overriden automatically by the bufenter, and InsertLeave
-- just turned on so the autocmd for InsertEnter which toggles line absoloute number
vim.opt.number = true
...
local function disable_key(key)
  vim.keymap.set('n', key, function()
    error('this is vim dont use ' .. key)
  end, { noremap = true })
end

-- disable arrow keys - todo: fix scrolling which relies on arrow keys
-- (ie scrolling up -> <Up> scrolling down = <Down> b/c of terminal emulator gnome terminal alacritty) might be called faux scrolling
disable_key '<Up>'
disable_key '<Down>'
disable_key '<Left>'
disable_key '<Right>'
